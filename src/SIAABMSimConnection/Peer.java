...
public class Peer extends Interaction{

	public Peer (Actor fromActor, Actor toActor, String interactionState, double interactionQuality){
	...
	public boolean respond(String event){
		...
		if(event.equals("OfferHelp")){
			...
			if(toThatActor.getChanceOfEvent(responseEvent)){
				//System.out.println("*** ACCEPTED HELP from Peer");
				...
				//System.out.println("*** DID NOT ACCEPT HELP from Peer");
				return false;
			}
		}
		if(event.equals("AskHelp")){
			if(toThatActor.getChanceOfEvent(responseEvent)){
				//System.out.println("*** Peer will HELP");
				toThatActor.increaseMotivation();
				...
				//System.out.println("### Peer IS BUSY");
				return false;
			}
		}
		return false;
