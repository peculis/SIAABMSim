...
public class ReworkTask extends Task{
	
	
	public ReworkTask (TEOW teow){
		//fromThisAgent = null;
		thisTEOW = teow;
		toThatAgent = thisTEOW.getDependency().toThatAgent;
		deliverable = (Artifact) toThatAgent;
		taskType = TaskType.Rework;
		productiveEffort = 0;
		overheadEffort = 0;
	}
	...
	public void estimate(Actor actor){
		thisTEOW.estimateRework(actor);
	}
	
	public void estimate(){
		thisTEOW.estimateRework((Actor) fromThisAgent);
	}
